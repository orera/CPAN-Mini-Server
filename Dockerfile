...
# After build:
# docker run -it -v /dir/to/minicpan:/root/minicpan cpanminiserver script/cpanminiserver.pl -i '' -p 9999 -m <mirror url> -d /root/minicpan

# docker run -it -v /dir/to/CPAN-Mini-Server:/root/CPAN-Mini-Server cpanminiserver minil dist
